...
func TestABI_DecodeAction(t *testing.T) {
	...
	mockData := struct {
		...
		F1:     Name("potato-coin.test-network.producer-name.bpa"),
	...
	assert.Equal(t, "potato-coin.test-network.producer-name.bpa", gjson.GetBytes(json, "struct_1_field_1").String())
...
func TestABI_decodeFields(t *testing.T) {
	...
	assert.JSONEq(t, `{"F1":"18446744073709551615", "F2":"potato-coin.test-network.producer-name.bpa"}`, string(json))
}
...
func TestABI_Read(t *testing.T) {
	...
	testCases := []map[string]interface{}{
		...
		{"caseName": "Name", "typeName": "name", "value": `"potato-coin.test-network.producer-name.bpa"`, "encode": Name("potato-coin.test-network.producer-name.bpa"), "expectedError": nil, "isOptional": false, "isArray": false, "fieldName": "testedField"},
		...
		{"caseName": "public_key", "typeName": "public_key", "value": `"POC1111111111111111111111111111111114T1Anm"`, "encode": ecc.MustNewPublicKey("EPOC1111111111111111111111111111111114T1Anm"), "expectedError": nil, "isOptional": false, "isArray": false, "fieldName": "testedField"},
		...
		{"caseName": "symbol", "typeName": "symbol", "value": `"4,POC"`, "encode": POCSymbol, "expectedError": nil, "isOptional": false, "isArray": false, "fieldName": "testedField"},
		...
		{"caseName": "asset", "typeName": "asset", "value": `"10.0000 POC"`, "encode": Asset{Amount: 100000, Symbol: POCSymbol}, "expectedError": nil, "isOptional": false, "isArray": false, "fieldName": "testedField"},
		{"caseName": "extended_asset", "typeName": "extended_asset", "value": "{\"asset\":\"0.0010 POC\",\"Contract\":\"potato-coin.test-network.producer-name.bpa\"}", "encode": ExtendedAsset{Asset: Asset{Amount: 10, Symbol: POCSymbol}, Contract: "potato-coin.test-network.producer-name.bpa"}, "expectedError": nil, "isOptional": false, "isArray": false, "fieldName": "testedField"},
...
func TestABI_Read_Symbol(t *testing.T) {
	...
	require.NoError(t, err)
	assert.Equal(t, `{"name":"4,POC"}`, string(out))
}
